...
//LOAD DEMO
var demo = {"last_node_id":11,"last_link_id":15,"nodes":[{"id":2,"type":"particles/Init Particles","pos":[194,223],"size":[262,106],"flags":{},"order":5,"mode":0,"inputs":[{"name":"Particle System","type":"ParticleSystem","link":1},{"name":"Min Lifetime","type":"number","link":null},{"name":"Max Lifetime","type":"number","link":null},{"name":"Min Speed","type":"vec3","link":null},{"name":"Max Speed","type":"vec3","link":null}],"outputs":[{"name":"Particle System","type":"ParticleSystem","links":[2]}],"properties":{"min_lifetime_value":0.5,"max_lifetime_value":10,"min_speed_x":0.5,"max_speed_x":0.5,"min_speed_y":0.5,"max_speed_y":0.5,"min_speed_z":0.5,"max_speed_z":0.5}},{"id":10,"type":"basic/const","pos":[-88,625],"size":[180,30],"flags":{},"order":1,"mode":0,"outputs":[{"name":"value","type":"number","links":[12],"label":"1.000"}],"properties":{"value":0.9999999999999997}},{"id":8,"type":"math3d/xyz-to-vec3","pos":[102,536],"size":[140,66],"flags":{},"order":6,"mode":0,"inputs":[{"name":"x","type":"number","link":9},{"name":"y","type":"number","link":10},{"name":"z","type":"number","link":11}],"outputs":[{"name":"vec3","type":"vec3","links":[8,14]}],"properties":{"x":0,"y":0,"z":0}},{"id":9,"type":"basic/const","pos":[-94,514],"size":[180,30],"flags":{},"order":2,"mode":0,"outputs":[{"name":"value","type":"number","links":[9,10,11],"label":"0.400"}],"properties":{"value":0.40000000000000013}},{"id":7,"type":"basic/const","pos":[-63,324],"size":[180,30],"flags":{},"order":3,"mode":0,"outputs":[{"name":"value","type":"number","links":[5],"label":"1.000"}],"properties":{"value":1}},{"id":11,"type":"basic/const","pos":[-72,422],"size":[180,30],"flags":{},"order":4,"mode":0,"outputs":[{"name":"value","type":"number","links":[15],"label":"1.800"}],"properties":{"value":1.7999999999999998}},{"id":1,"type":"particles/Init System","pos":[-8,103],"size":[210,58],"flags":{},"order":0,"mode":0,"inputs":[{"name":"Position","type":"vec3","link":null}],"outputs":[{"name":"Particle System","type":"ParticleSystem","links":[1]}],"properties":{"x":0,"y":0,"z":0,"maxParticles":200,"id":1,"mesh_id":0}},{"id":3,"type":"particles/Basic Move Particles","pos":[535,337],"size":[140,46],"flags":{},"order":9,"mode":0,"inputs":[{"name":"Particle System","type":"ParticleSystem","link":2},{"name":"Vortex Noise","type":"VortexNoise","link":13}],"properties":{}},{"id":5,"type":"particles/Vortex Noise","pos":[271,496],"size":[220,138],"flags":{},"order":8,"mode":0,"inputs":[{"name":"Position","type":"vec3","link":4},{"name":"Speed","type":"vec3","link":14},{"name":"Angular speed","type":"vec3","link":8},{"name":"Scale","type":"number","link":12},{"name":"Lifetime","type":"number","link":null}],"outputs":[{"name":"Vertex Noise","type":"VortexNoise","links":[13]}],"properties":{"noise":{"id":5,"position":[1,1.7999999523162842,0],"angularSpeed":[0.4000000059604645,0.4000000059604645,0.4000000059604645],"speed":[0.4000000059604645,0.4000000059604645,0.4000000059604645],"scale":0.9999999999999997,"actualLife":10,"lifetime":10},"show":true}},{"id":6,"type":"math3d/xyz-to-vec3","pos":[133,383],"size":[140,66],"flags":{},"order":7,"mode":0,"inputs":[{"name":"x","type":"number","link":5},{"name":"y","type":"number","link":15},{"name":"z","type":"number","link":null}],"outputs":[{"name":"vec3","type":"vec3","links":[4]}],"properties":{"x":0,"y":0,"z":0}}],"links":[[1,1,0,2,0,"ParticleSystem"],[2,2,0,3,0,"ParticleSystem"],[4,6,0,5,0,"vec3"],[5,7,0,6,0,"number"],[8,8,0,5,2,"vec3"],[9,9,0,8,0,"number"],[10,9,0,8,1,"number"],[11,9,0,8,2,"number"],[12,10,0,5,3,"number"],[13,5,0,3,1,"VortexNoise"],[14,8,0,5,1,"vec3"],[15,11,0,6,1,"number"]],"groups":[],"config":{},"version":0.4};
