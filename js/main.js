...
function init () 
{
	...
	document.addEventListener("visibilitychange", function(){
		...
		else if (is_graph_running && graph.status == LGraph.STATUS_STOPPED)
		{
			console.log("Start")
			graph.start();
		}
