...
//Basic fire
var demo5 = {"last_node_id":11,"last_link_id":13,"nodes":[{"id":2,"type":"basic/color picker","pos":[48,258],"size":[210,130],"flags":{},"order":0,"mode":0,"outputs":[{"name":"Color","type":"color","links":[4]}],"properties":{"color":[0.82,0.36999999999999933,0,1]}},{"id":1,"type":"spawn/spawn","pos":[53,78],"size":[210,142],"flags":{},"order":1,"mode":0,"inputs":[{"name":"Max particles","type":"number","link":null},{"name":"Spawn rate","type":"number","link":null},{"name":"Color","type":"color","link":null},{"name":"Position","type":"vec3","link":null}],"outputs":[{"name":"Spawner","type":"spawner","links":[3]}],"properties":{"max_particles":100,"spawn_rate":10,"position":[0,0,0],"mode":"Point","mesh_mode":"Surface","color":[1,1,1,1]}},{"id":3,"type":"init/init","pos":[364,78],"size":[245.1999969482422,186],"flags":{},"order":5,"mode":0,"inputs":[{"name":"Spawner","type":"spawner","link":3},{"name":"Max speed","type":"vec3","link":null},{"name":"Min speed","type":"vec3","link":null},{"name":"Max life time","type":"number","link":null},{"name":"Min life time","type":"number","link":null},{"name":"Max size","type":"number","link":null},{"name":"Min size","type":"number","link":null},{"name":"Color","type":"color","link":4},{"name":"Texture","type":"texture","link":5}],"outputs":[{"name":"Particle system","type":"particle_system","links":[6,8]}],"properties":{"max_speed":[0.25,1,0.25],"min_speed":[-0.15,0.5,-0.15],"max_size":0.25,"min_size":0.25,"max_life_time":10,"min_life_time":10,"color":[0.82,0.36999999999999933,0,1]}},{"id":6,"type":"conditions/create condition","pos":[347,418],"size":[211.60000610351562,102],"flags":{},"order":6,"mode":0,"inputs":[{"name":"Particle system","type":"particle_system","link":6},{"name":"Life time","type":"number","link":null}],"outputs":[{"name":"Condition","type":"condition_list","links":[7,9]}],"properties":{"system_property":"Life time","condition":"Greater than","value":1.76}},{"id":8,"type":"modify/modify property","pos":[694,612],"size":[262,166],"flags":{},"order":8,"mode":0,"inputs":[{"name":"Particle system","type":"particle_system","link":11},{"name":"Condition","type":"condition_list","link":9},{"name":"Change equation","type":"equation","link":13},{"name":"New color","type":"color","link":10}],"outputs":[{"name":"Particle system","type":"particle_system","links":null}],"properties":{"changed_property":"Color","application_mode":"Equalization","modification_mode":"Along life time","user_defined_seconds":5,"new_value":[0.12999999999999984,0,0,0.14000000000000007]}},{"id":10,"type":"modify/modify property","pos":[704,183],"size":[262,166],"flags":{},"order":9,"mode":0,"inputs":[{"name":"Particle system","type":"particle_system","link":12},{"name":"Condition","type":"condition_list","link":null},{"name":"Change equation","type":"equation","link":null},{"name":"New speed","type":"vec3","link":null}],"outputs":[{"name":"Particle system","type":"particle_system","links":[]}],"properties":{"changed_property":"Speed","application_mode":"Equalization","modification_mode":"Along life time","user_defined_seconds":5,"new_value":[0,0,0]}},{"id":7,"type":"modify/modify property","pos":[700,397],"size":[262,166],"flags":{},"order":7,"mode":0,"inputs":[{"name":"Particle system","type":"particle_system","link":8},{"name":"Condition","type":"condition_list","link":7},{"name":"Change equation","type":"equation","link":null},{"name":"New size","type":"number","link":null}],"outputs":[{"name":"Particle system","type":"particle_system","links":[11,12]}],"properties":{"changed_property":"Size","application_mode":"Equalization","modification_mode":"Along life time","user_defined_seconds":5,"new_value":2}},{"id":9,"type":"basic/color picker","pos":[339,649],"size":[210,130],"flags":{},"order":3,"mode":0,"outputs":[{"name":"Color","type":"color","links":[10]}],"properties":{"color":[0.12999999999999984,0,0,0.14000000000000007]}},{"id":4,"type":"basic/load texture","pos":[47,426],"size":[210,194],"flags":{},"order":2,"mode":0,"outputs":[{"name":"Texture","type":"texture","links":[5]}],"properties":{"file":"","subtextures":false,"subtextures_size":[0,0]}},{"id":11,"type":"basic/equation","pos":[161,844],"size":[344,191],"flags":{},"order":4,"mode":0,"outputs":[{"name":"Equation","type":"equation","links":[13]}],"properties":{"curve_points":[[0,1],[0.13953488372093023,0.9842931937172775],[0.48546511627906974,0.6335078534031413],[1,1]]}}],"links":[[3,1,0,3,0,"spawner"],[4,2,0,3,7,"color"],[5,4,0,3,8,"texture"],[6,3,0,6,0,"particle_system"],[7,6,0,7,1,"condition_list"],[8,3,0,7,0,"particle_system"],[9,6,0,8,1,"condition_list"],[10,9,0,8,3,"color"],[11,7,0,8,0,"particle_system"],[12,7,0,10,0,"particle_system"],[13,11,0,8,2,"equation"]],"groups":[],"config":{},"extra":{},"version":0.4};
