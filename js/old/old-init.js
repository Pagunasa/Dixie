...
document.getElementById("graphLoader").onmouseover = function() {
	document.getElementById("load").style.background = "#eceff1";
	document.getElementById("load").style.color = "#455a64";
};

document.getElementById("graphLoader").onmouseout = function() {
	document.getElementById("load").style.background = "#455a64";
	document.getElementById("load").style.color = "#eceff1";
};
